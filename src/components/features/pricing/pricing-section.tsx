  ...
  const ongPlans: PricingPlan[] = [
    {
      name: "Starter",
      description:
        "Ideal para pequeñas organizaciones que publican de forma ocasional.",
      price: 15,
      publications: 3,
      features: [],
        ...
        <div className="w-full max-w-[1000px] flex justify-center items-center">
          <div className="relative flex border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] bg-white">
            ...
            <button
              ...
              style={{
                backgroundColor:
                  organizationType === "ong" ? "transparent" : "white",
              }}
            >
              <span
            ...
            <button
              ...
              style={{
                backgroundColor:
                  organizationType === "corporate" ? "transparent" : "white",
              }}
            >
              <span
                className={`transition-colors duration-300 text-center ${
        ...
        <div className="w-full max-w-[1000px] flex flex-col md:flex-row justify-center items-stretch gap-4 md:gap-6">
          {currentPlans.map((plan, index) => {
            ...
            return (
              <div
                key={plan.name}
                className="bg-white flex-1 border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] flex flex-col justify-start items-start gap-6 p-6 md:p-8"
              >
                <div className="self-stretch flex flex-col justify-start items-start gap-4">
                  <div className="self-stretch flex flex-col justify-start items-start gap-2">
                    <div className="text-xl font-bold leading-7 font-darker-grotesque">
                      {plan.name}
                    </div>
                    <div className="w-full text-sm font-medium leading-5 font-sans">
                      {plan.description}
                    </div>
                  </div>
                  ...
                  <div className="self-stretch flex flex-col justify-start items-start gap-2">
                    <div className="flex flex-col justify-start items-start gap-1">
                      <div className="relative h-[60px] flex items-center text-5xl font-bold leading-[60px] font-darker-grotesque">
                  ...
                  <button
                    className="bg-black text-white self-stretch px-4 py-3 border-4 border-black flex justify-center items-center transition-all duration-150 hover:translate-x-1 hover:translate-y-1 hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
